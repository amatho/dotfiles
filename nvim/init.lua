-- Based on https://github.com/nvim-lua/kickstart.nvim/blob/9288f4adcb25ebc70dab2ba0cd6b910b1fde57bf/init.lua
...
--Relative line numbers with absolute line number on current line
vim.opt.number = true
...
vim.api.nvim_set_keymap('n', 'X', ':BufferClose<CR>', { noremap = true, silent = true })
